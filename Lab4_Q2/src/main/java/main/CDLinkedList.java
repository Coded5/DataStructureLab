...
public class CDLinkedList {
    ...
    public void swapRange(Iterator s1, Iterator f1, Iterator s2, Iterator f2) {
        ...
        if (!(s1 instanceof DListIterator &&
                s2 instanceof DListIterator &&
                f1 instanceof DListIterator &&
                f2 instanceof DListIterator)) {
            return;
        }
        ...
        DListNode pStart1 = start1.previousNode;
        DListNode pStart2 = start2.previousNode;
        DListNode nFinal1 = final1.nextNode;
        DListNode nFinal2 = final2.nextNode;

        if (final1.nextNode == start2) {
            pStart1.nextNode = start2;
            start2.previousNode = pStart1;

            final2.nextNode = start1;
            start1.previousNode = final2;

            final1.nextNode = nFinal2;
            nFinal2.previousNode = final1;
        } else {
            pStart2.nextNode = start1;
            start1.previousNode = pStart2;

            pStart1.nextNode = start2;
            start2.previousNode = pStart1;

            nFinal1.previousNode = final2;
            final2.nextNode = nFinal1;
